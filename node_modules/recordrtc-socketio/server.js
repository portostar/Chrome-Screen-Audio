...
function merge(socket, fileName) {
    ...
    new FFmpeg({
            source: videoFile
				...
				ffmpeg.setFfmpegPath("/var/lib/openshift/568140c27628e166960000cc/app-root/data/bin/ffmpeg");
        ffmpeg.addInput(audioFile)
        on('error', function(err, stdout, stderr) {
        socket.emit('ffmpeg-error', 'ffmpeg : An error occurred: ' + err.message+stdout+stderr);
    })
