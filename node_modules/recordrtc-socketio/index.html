...
<head>
	...
	<script src="http://localhost/Chrome_Screen_Audio/socket.io.js"> </script>
	<script>
	...
	<script>
			...
			socketio.connect('http://127.0.0.1:8888'); 
...
stopRecordingButton.onclick = function () {
  ...
  function startRecording() {
    ...
    navigator.getUserMedia({
		...
		__log("recordAudio = new RecordRTC");
  ...
  function stopAllRecordings() {
	__log("stopAllRecordings called");
	if (globalFilename==0)
	{	
